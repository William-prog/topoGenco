...
class CreateRegistroMantenimientoCiensTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('registro_mantenimiento_ciens', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('registro_mantenimiento_ciens');
    }
}
