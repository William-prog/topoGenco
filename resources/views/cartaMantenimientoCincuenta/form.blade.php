        ...
        <div class="col-md-10">
            ...
            <div class="row mt-1">
                ...
                <div class="form-group col-md-12">
                    ...
                    <div class="row mt-1">
                        <div class="divCheckList form-group col-10">
                            <label>a) Inspección a mangueras y abrazaderas del motor Diésel Cummins B3.3 </label>
                        </div>
                    ...
                    <div class="row mt-1">
                        <div class="divCheckList form-group col-10">
                            <label>c) Limpiar y revisar en general ensamble de filtro de admisión, sujetadores y alojamiento se
                                encuentren en buen estado.</label>
                        </div>
                        <div class="divCheckList form-group col-1">
                    ...
                    <div class="row mt-1">
                        <div class="divCheckList form-group col-10">
                            <label>d) Asegurar que el filtro de admisión primario está en buenas condiciones (sacarlo y sacudirlo).
                            </label>
                        </div>
                        <div class="divCheckList form-group col-1">
                    ...
                    <div class="row mt-1">
                        <div class="divCheckList form-group col-10">
                            <label>f) Revisar motor Diesel en general para detectar posibles fugas o daños. </label>
                        </div>
                        <div class="divCheckList form-group col-1">
                    ...
                    <div class="row mt-1">
                        <div class="divCheckList form-group col-10">
                            <label>i) Verificar nivel de aceite de motor(15W40).</label>
                        </div>
                        <div class="divCheckList form-group col-1">
                ...
                <div class="form-group col-md-12">
                    ...
                    <div class="row mt-1">
                        <div class="divCheckList form-group col-10">
                            <label>b) Comprobar el sistema de supresión de incendios (si existe).</label>
                        </div>
                        <div class="divCheckList form-group col-1">
                    ...
                    <div class="row mt-1">
                        <div class="divCheckList form-group col-10">
                            <label>c) Verificación a las condiciones estructurales y físicas del área útil (techo /suelo de
                                cabina).</label>
                        </div>
                        <div class="divCheckList form-group col-1">
                            <input type="checkbox" class="checkbox" name="mtto_estructura_3" id="mtto_estructura_3" value="Si">
                        </div>
                    </div>
                </div>
                <!-- Lubricación -->
                <div class="form-group col-md-12">
                    ...
                    <div class="row mt-1">
                        <div class="divCheckList form-group col-10">
                            <label>a) Lubricación de tren motriz. (lubricación de crucetas). </label>
                        </div>
                        <div class="divCheckList form-group col-1">
                ...
                <div class="form-group col-md-12">
                    ...
                    <div class="row mt-1">
                        <div class="divCheckList form-group col-10">
                            <label>a) Verificar nivel adecuado de aceite hidráulico de freno de estacionaminento. </label>
                        </div>
                        <div class="divCheckList form-group col-1">
                    ...
                    <div class="row mt-1">
                        <div class="divCheckList form-group col-10">
                            <label>b) Comprobación del buen estado de mangueras y conexiones del sistema de freno de
                ...
                <div class="form-group col-md-12">
                    ...
                    <div class="row mt-1">
                        <div class="divCheckList form-group col-10">
                            <label>a) Revisar nivel adecuado de liquido de frenos de servicio en depósito, en caso de ser faltante
                                reponer con Fluido para Frenos DOT3. </label>
                        </div>
                        <div class="divCheckList form-group col-1">
                    ...
                    <div class="row mt-1">
                        <div class="divCheckList form-group col-10">
                            <label>b) Realizar pruebas de aplicación y liberación de freno de estacionamiento (de ser posible realizar
                                en rampa). </label>
                        </div>
                        <div class="divCheckList form-group col-1">
                    ...
                    <div class="row mt-1">
                        <div class="divCheckList form-group col-10">
                            <label>c) Revisar nivel de desgaste de balatas traseras y delanteras GMS-167HD. </label>
                        </div>
                        <div class="divCheckList form-group col-1">
                    ...
                    <div class="row mt-1">
                        <div class="divCheckList form-group col-10">
                            <label>d) Inspección a líneas de frenos de servicio en búsqueda de alguna fuga. </label>
                        </div>
                        <div class="divCheckList form-group col-1">
                ...
                <div class="form-group col-md-12">
                    ...
                    <div class="row mt-1">
                        <div class="divCheckList form-group col-10">
                            <label>a) Verificar nivel de aceite de dirección (rellenar de ser necesario). </label>
                        </div>
                        <div class="divCheckList form-group col-1">
                    ...
                    <div class="row mt-1">
                        <div class="divCheckList form-group col-10">
                            <label>b) Verificar nivel de aceite de transmisión (rellenar de ser necesario). </label>
                        </div>
                        <div class="divCheckList form-group col-1">
                    ...
                    <div class="row mt-1">
                        <div class="divCheckList form-group col-10">
                            <label>c) Verificar nivel de aceite de diferencial delantero (rellenar de ser necesario).</label>
                        </div>
                        <div class="divCheckList form-group col-1">
                    ...
                    <div class="row mt-1">
                        <div class="divCheckList form-group col-10">
                            <label>d) Verificar nivel de aceite de diferencial trasero (rellenar de ser necesario).
                            </label>
                        </div>
                        <div class="divCheckList form-group col-1">
                    ...
                    <div class="row mt-1">
                        <div class="divCheckList form-group col-10">
                            <label>e) Verificar nivel de aceite en transfer (rellenar de ser necesario). </label>
                        </div>
                        <div class="divCheckList form-group col-1">
                    ...
                    <div class="row mt-1">
                        <div class="divCheckList form-group col-10">
                            <label>f) Inspección de tornillería de sujeción de base de palanca de embrague. </label>
                        </div>
                        <div class="divCheckList form-group col-1">
                    ...
                    <div class="row mt-1">
                        <div class="divCheckList form-group col-10">
                            <label>g) Revisar estado de llantas y su presión de aire, 40 psi (calibrar de ser necesario). </label>
                        </div>
                        <div class="divCheckList form-group col-1">
                    ...
                    <div class="row mt-1">
                        <div class="divCheckList form-group col-10">
                            <label>h) Inspección de tuercas y birlos de llantas, realizar reapriete de ser necesario.</label>
                        </div>
                        <div class="divCheckList form-group col-1">
                            <input type="checkbox" class="checkbox" name="mtto_trenFuerza_8" id="mtto_trenFuerza_8" value="Si">
                        </div>
                    </div>

                    <div class="row mt-1">
                        <div class="divCheckList form-group col-10">
                            <label>i) Comprobar correcto funcionamiento de sistema 4x4.</label>
                        </div>
                        <div class="divCheckList form-group col-1">
                            <input type="checkbox" class="checkbox" name="mtto_trenFuerza_9" id="mtto_trenFuerza_9" value="Si">
                        </div>
                    </div>
                </div>
                <!-- Sistema eléctrico -->
                <div class="form-group col-md-12">
                    ...
                    <div class="row mt-1">
                        <div class="divCheckList form-group col-10">
                            <label>c) Comprobar carga y funcionamiento de las baterías.</label>
                        </div>
                        <div class="divCheckList form-group col-1">
